...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
    	...
    	prop.put("mail.smtp.user", "tutlejin96@gmail.com.");
    	...
    	prop.put("mail.smtp.port", "465"); // 465 -> 587
    	...
    	// 제목 설정
    	String subject = "localhost:9090/Semiproject_2/index.go 회원님의 비밀번호를 찾기위한 인증코드 발송";
    	msg.setSubject(subject);
    	        
    	// 보내는 사람의 메일주소
    	String sender = "tutlejin96@gmail.com";
