...
public class NoticeDAO implements InterNoticeDAO {
    ...
    // 공지사항 글 작성시키는 메소드
	@Override
	public void register(String notice_id, String notice_subject, String notice_content, String nimage) throws SQLException {
		
		try {
  			conn = ds.getConnection();
  			
  			String sql = " insert into tbl_notice(notice_num, notice_id, notice_subject, notice_content, nimage) "
	...
	public List<NoticeVO> selectPagingnotice() throws SQLException {
		...
		List<NoticeVO> noticeList = new ArrayList<>();
	      ...
	      try {
	         ...
	         String sql = " select notice_num, notice_id, notice_subject, notice_content, notice_count, notice_date, nimage "
	        		 	+ " from tbl_notice "; 
