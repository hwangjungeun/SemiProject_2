...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		/*
		//스피너 값이 변하면 보여주는 값 또한 변함=>안먹힘
		$("input#oqty").bind("input",function(){
		
			alert("클릭됨!");
			var $target = $(this); 
			var cnt = $target.attr("value");
		
			console.log("cnt => " +cnt);
			
			var price = ${requestScope.pvo.price};
		...
		*/
		...
		});// end of $(document).on("click","button#submit3", function(){})---------- 
	...
	// 장바구니 버튼 클릭했을때 => 안잡혀서 위로 넣음 
	function gobasket(){
	
		
	}// end of function gobasket()-----------------------------------------------------------------------
